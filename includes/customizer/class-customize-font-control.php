...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Donovan_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'donovan-pro' ),
				'next'     => esc_html__( 'Next Font', 'donovan-pro' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'donovan-pro' ),
			);

			// Set Fonts.
			$this->local_fonts = Donovan_Pro_Custom_Fonts::get_local_fonts();
			$this->google_fonts = Donovan_Pro_Custom_Fonts::get_google_fonts();
				...
				<label>
					...
					<div class="customize-font-select-control">
						<select <?php $this->link(); ?>>
							<optgroup label="<?php esc_html_e( 'Local Fonts', 'donovan-pro' ); ?>">
								<?php
							...
							<optgroup label="<?php esc_html_e( 'Google Web Fonts', 'donovan-pro' ); ?>">
	  							<?php
